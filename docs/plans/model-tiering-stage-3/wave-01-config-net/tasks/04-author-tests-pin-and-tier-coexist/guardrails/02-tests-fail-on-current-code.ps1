...
# The MODEL-pin entry is the load-bearing one: TierResolver.cs:139 is `Runner is not null || Model is
# not null`, so a model pin ALONE kills the tier. A "both required" reading of DoR §13.2's slash would
