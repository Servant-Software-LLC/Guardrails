...
# Pairs with: the 00 POSITIVE preflight (which proved the suite was green before we started) and
# the 02/03 NEGATIVE baseline (which proved the new field was absent, so this green is provably
# this task's doing — not pre-existing).
