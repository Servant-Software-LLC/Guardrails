# catches: a "red" that is really a COMPILE error - indistinguishable from a genuine failure by exit code,
#          and unfixable by the implementation task, whose writeScope excludes the test file.
