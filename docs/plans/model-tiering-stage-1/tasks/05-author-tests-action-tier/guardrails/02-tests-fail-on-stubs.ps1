...
# spelling would also select the sibling ActionTierProvenanceTests class (#193).
...
if ($code -eq 0) {
    Write-Output "The ActionTierTests tests PASS against the NotImplementedException stubs - they assert nothing real."
    exit 1
}
exit 0
