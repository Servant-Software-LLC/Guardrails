...
:::question
{ "id": "prefix-corpus-era", "title": "92 older failed rows carry no provenance and 447 of 587 name no usable model. What happens to the pre-fix corpus?",
  "mode": "single",
...
:::question
{ "id": "577-ownership", "title": "Does Phase 1 OWN closing the model-attribution gap (#577), or only the census that scopes it?",
  "mode": "single",
...
:::question
{ "id": "model-digest-scope", "title": "#223 has SHIPPED, so this section's own trigger has fired — is the model digest in Phase 1 scope now?",
  "mode": "single",
...
:::question
{ "id": "unified-memory-fact", "title": "Is the incoming Mac Studio really the TIGHTER box than the 128GB MacBook? The plan's reasoning depends on it.",
  "mode": "single",
...
:::note
**Every dependency this section names is now CLOSED, verified 2026-09-01.** #547 (test suites
