...
#   $env:GR_SUBJECT='docs/plans/31-unattended-run-hardening/tasks/06-stub-the-plan-edit-watch/samples/02-stubs-declared-and-inert.valid.cs';   <this script>  # expect 0
#   $env:GR_SUBJECT='docs/plans/31-unattended-run-hardening/tasks/06-stub-the-plan-edit-watch/samples/02-stubs-declared-and-inert.invalid.cs'; <this script>  # expect 1
