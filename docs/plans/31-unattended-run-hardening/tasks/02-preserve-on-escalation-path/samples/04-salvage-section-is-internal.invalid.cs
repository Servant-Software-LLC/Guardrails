// Sample: the ONE defect 04-salvage-section-is-internal.ps1 exists to catch -> must exit NON-ZERO.
...
internal static class RetryPolicy
{
    ...
    private static void AppendSalvageSection(System.Text.StringBuilder text, SalvageRef? salvageRef,
