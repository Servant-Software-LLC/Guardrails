...
$filter = 'Category=BacklogSlate&FullyQualifiedName~ModelInRowTests'   # SAME string as the pair's forward half (task 11)
...
# Cross-checked BY HAND against tasks/10-author-tests-model-in-row/action.prompt.md (Group A) - the
