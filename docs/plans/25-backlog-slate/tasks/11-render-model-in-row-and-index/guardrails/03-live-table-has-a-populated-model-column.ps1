...
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/11-render-model-in-row-and-index/samples/03-live-table-has-a-populated-model-column.valid.cs';   ./docs/plans/25-backlog-slate/tasks/11-render-model-in-row-and-index/guardrails/03-live-table-has-a-populated-model-column.ps1  # expect 0
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/11-render-model-in-row-and-index/samples/03-live-table-has-a-populated-model-column.invalid.cs'; ./docs/plans/25-backlog-slate/tasks/11-render-model-in-row-and-index/guardrails/03-live-table-has-a-populated-model-column.ps1  # expect 1
#
...
#                                     No ancestor task writes this token into this subject: task 10's
...
# The FLOOR of 2, not a presence check: the declaration itself matches `ModelCell(`, and task 10 has
