...
- Write everything you publish under your task's FOLDER NAME as the single top-level
  ...
  `{ "11-render-model-in-row-and-index": { "someKey": "someValue" } }`. The harness
...
task page. Turn the tests task 10 authored green — **without changing them**.
...
scope and you may not edit it. Your guardrail runs the SAME filter that task 10's red census ran.
...
`LiveRunObserver.ModelCell` was added as a `throw new NotImplementedException();` stub by task 10,
