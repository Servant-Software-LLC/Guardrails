...
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/04-wire-verifier-into-preflight/samples/01-wiring-test-drives-the-real-phase.valid.cs';   ./01-...ps1  # expect 0
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/04-wire-verifier-into-preflight/samples/01-wiring-test-drives-the-real-phase.invalid.cs'; ./01-...ps1  # expect 1
#
