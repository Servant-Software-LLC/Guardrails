...
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/03-add-samples-verify-command/samples/01-verb-drives-the-shared-verifier.valid.cs';   ./01-...ps1  # expect 0
#   $env:GR_SUBJECT='docs/plans/25-backlog-slate/tasks/03-add-samples-verify-command/samples/01-verb-drives-the-shared-verifier.invalid.cs'; ./01-...ps1  # expect 1
#
