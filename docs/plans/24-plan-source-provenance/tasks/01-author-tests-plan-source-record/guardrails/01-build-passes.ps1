...
if ($LASTEXITCODE -ne 0) {
    Write-Output "tests/Guardrails.Core.Tests does not build - PlanSourceRecordTests.cs or the PlanSourceRecord stub is not type-correct (see the compiler errors above)"
    exit 1
}
exit 0
