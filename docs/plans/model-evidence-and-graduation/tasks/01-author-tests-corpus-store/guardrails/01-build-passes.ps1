...
if ($buildExit -ne 0) {
    ...
    Write-Output "TelemetryCorpusStoreTests.cs (or its stubs) does not COMPILE - a TDD red must compile and fail, not fail to build. Add the minimal NotImplementedException stubs the tests need."
    exit 1
}
exit 0
