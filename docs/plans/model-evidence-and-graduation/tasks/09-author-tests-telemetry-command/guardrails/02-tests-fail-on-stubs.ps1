...
$filter = 'Category=ModelEvidence&(FullyQualifiedName~TelemetryCommandTests|FullyQualifiedName~TelemetryCommandWiringTests)'
$behaviours = @(
    @{ Name = 'ingest writes rows from a plan journal';          Test = 'Ingest_WritesRowsFromAPlanJournal' },
