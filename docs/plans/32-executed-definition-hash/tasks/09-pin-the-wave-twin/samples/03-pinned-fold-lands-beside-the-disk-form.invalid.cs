// The ONE defect 03-pinned-fold-lands-beside-the-disk-form.ps1 exists to catch: the pinned fold
// REPLACING the disk form instead of landing beside it. Stage 8's two pins are entirely happy with
// this - the WRITE stamps the right value - and the shipped suite that drives the disk form stays
// green too, because its fixtures are unedited. It surfaces much later, as a wave-drift compare
// that is comparing a pin against a pin and therefore checking nothing.
