// EXTRA CASE: the on-disk edit deleted, which makes the divergence go away by removing the SCENARIO
// rather than by fixing how the resume is modelled. Section 11's rule for every timing fixture in this
// plan: the edit IS the fixture.
