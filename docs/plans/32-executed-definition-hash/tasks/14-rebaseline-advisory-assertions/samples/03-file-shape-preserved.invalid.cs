// The ONE defect 03-file-shape-preserved.ps1 exists to catch at this stage: half a rename. The old
// method name is gone and the new one never arrived, so the file now has four facts where it had
// five - and guardrail 02 census is entirely happy, because the two rows it manifests are elsewhere.
using System.IO;
