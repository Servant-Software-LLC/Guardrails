...
// .invalid pair): the rename copied rather than moved, so both names live in the file. Six facts
// where there were five, and two methods asserting opposite things about the same run.
using System.IO;
