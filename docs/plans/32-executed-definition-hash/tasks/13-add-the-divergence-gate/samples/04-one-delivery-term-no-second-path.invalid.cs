// The ONE defect 04-one-delivery-term-no-second-path.ps1 exists to catch: a SECOND delivery
// predicate. It agrees with the first one on every case anybody wrote a pin for, which is
// exactly how the shipped defect it is named after got in, and it diverges later on the case
// nobody did. Identical to the .valid half apart from the added member.
...
public sealed record RunReport
{
    ...
    public bool ShouldDeliver => !HasDefinitionDrift && !HasWaveHalt && !Aborted && Tasks.All(t => t.IsGreen);
