// The ONE defect 04-ignore-predicate-has-one-home.ps1 exists to catch: the promotion that never
// happened. The watch is unchanged and still correct on its own terms - which is exactly the problem,
// because nothing about this file looks wrong. Eight stages later the gate cannot reach the predicate,
// and its only in-scope moves are a second copy of the list or no filter at all.
using System;
