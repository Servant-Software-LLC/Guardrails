// EXTRA CASE: the surviving green-run assertion taken out along with the one rewritten three lines
// below it - the single most expensive loss this stage invites (section 15.1's 'one assertion that must
// NOT move'). Five methods, none skipped, row 2 inverted, rationale intact: only clause 3 catches it.
using System.IO;
