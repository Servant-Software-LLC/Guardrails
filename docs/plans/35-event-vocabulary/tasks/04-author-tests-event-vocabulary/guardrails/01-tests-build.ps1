...
#          Task 05 owns RunEventStream.cs and cannot touch this file.
$ErrorActionPreference = 'Continue'
$log = & dotnet build tests/Guardrails.Core.Tests/Guardrails.Core.Tests.csproj -c Debug -v q --nologo 2>&1 | Out-String
$code = $LASTEXITCODE
Write-Output $log
if ($code -ne 0) {
    Write-Output ""
