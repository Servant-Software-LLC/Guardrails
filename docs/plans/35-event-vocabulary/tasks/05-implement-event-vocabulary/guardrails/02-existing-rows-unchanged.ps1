# catches: a widening that CHANGED the kinds that already shipped. The additive lifecycle
#          kinds landed on e7ba57d and their existing tests assert their exact shape; a consumer
#          already parses them. Widening must be additive, not a reshape.
$ErrorActionPreference = 'Continue'
$env:DOTNET_CLI_UI_LANGUAGE = 'en'

$filter = "FullyQualifiedName~RunEventStreamTests"
...
Write-Output "All $passed test(s) pass for RunEventStreamTests."
exit 0
