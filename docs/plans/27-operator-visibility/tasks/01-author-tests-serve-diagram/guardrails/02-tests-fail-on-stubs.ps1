...
$filter = 'Category=BacklogSlate&FullyQualifiedName~ServeDiagramTests'   # SAME string as the pair's forward half (task 02)
...
# Cross-checked BY HAND against tasks/01-author-tests-serve-diagram/action.prompt.md (Group A) - the
