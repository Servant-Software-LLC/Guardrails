...
/// <summary>
/// MUTANT M1. The raise is relocated INSIDE the §6.2 no-route branch. It compiles, it is still
/// textually ABOVE _actionRunner.RunAsync, and the guard `route is { NoRoute: true }` means it fires
/// for NO ATTEMPT THAT EVER LAUNCHES — every consuming surface stays empty forever.
/// </summary>
