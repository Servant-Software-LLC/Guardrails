...
flowchart TD
  ...
  subgraph task_03_author_tests_diagram_refresh["03-author-tests-diagram-refresh"]
    task_03_author_tests_diagram_refresh_gr_0["01-build-passes"]:::guardrail
    task_03_author_tests_diagram_refresh_gr_1["02-tests-fail-on-stubs"]:::guardrail
  end
  style task_03_author_tests_diagram_refresh fill:#cfe8ff,stroke:#1b6ec2,color:#0b2545;
  subgraph task_04_replace_meta_refresh["04-replace-meta-refresh"]
    task_04_replace_meta_refresh_gr_0["01-build-passes"]:::guardrail
    task_04_replace_meta_refresh_gr_1["02-diagram-refresh-tests-pass"]:::guardrail
    task_04_replace_meta_refresh_gr_2["03-neighbour-diagram-coverage-survives"]:::guardrail
  end
  style task_04_replace_meta_refresh fill:#cfe8ff,stroke:#1b6ec2,color:#0b2545;
  subgraph task_05_raise_attempt_route_resolved["05-raise-attempt-route-resolved"]
    task_05_raise_attempt_route_resolved_gr_0["01-build-passes"]:::guardrail
    task_05_raise_attempt_route_resolved_gr_1["02-route-event-raised-before-the-action-runs"]:::guardrail
    task_05_raise_attempt_route_resolved_gr_2["03-both-decorators-forward-the-route-event"]:::guardrail
    task_05_raise_attempt_route_resolved_gr_3["04-model-disclosure-neighbours-still-pass"]:::guardrail
  end
  style task_05_raise_attempt_route_resolved fill:#cfe8ff,stroke:#1b6ec2,color:#0b2545;
  subgraph task_06_author_tests_model_in_row["06-author-tests-model-in-row"]
    task_06_author_tests_model_in_row_gr_0["01-build-passes"]:::guardrail
    task_06_author_tests_model_in_row_gr_1["02-tests-fail-on-stubs"]:::guardrail
    task_06_author_tests_model_in_row_gr_2["03-tests-do-not-construct-the-live-observer"]:::guardrail
  end
  style task_06_author_tests_model_in_row fill:#cfe8ff,stroke:#1b6ec2,color:#0b2545;
  subgraph task_07_render_model_in_row_and_index["07-render-model-in-row-and-index"]
    task_07_render_model_in_row_and_index_gr_0["01-build-passes"]:::guardrail
    task_07_render_model_in_row_and_index_gr_1["02-model-in-row-tests-pass"]:::guardrail
    task_07_render_model_in_row_and_index_gr_2["03-live-table-has-a-populated-model-column"]:::guardrail
  ...
  task_02_serve_diagram_from_log_site --> task_03_author_tests_diagram_refresh
  task_03_author_tests_diagram_refresh --> task_04_replace_meta_refresh
