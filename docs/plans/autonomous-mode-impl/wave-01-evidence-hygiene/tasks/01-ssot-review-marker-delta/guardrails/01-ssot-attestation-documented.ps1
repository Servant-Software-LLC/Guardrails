...
#          SSOT-first contract (invariant 4). Scoped to the one file this task owns.
...
$required = @('attestation', 'review-artifact', 'bare', 'machine', 'reportDigest', 'Plan-Definition-Hash')
