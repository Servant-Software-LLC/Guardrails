...
$WorktreeRoot = "C:\Users\David\AppData\Local\Temp\guardrails-worktrees\diagram-live-status-and-search-80c8913d\55da8a20\01-author-tests-diagram-status-overlay-renderer\attempt-1"
