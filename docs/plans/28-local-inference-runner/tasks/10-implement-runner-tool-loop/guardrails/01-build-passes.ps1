...
#          guardrail on this task is meaningless over a tree that does not build, and for this task a compile failure means the tool loop no longer matches the containment primitive's signature.
