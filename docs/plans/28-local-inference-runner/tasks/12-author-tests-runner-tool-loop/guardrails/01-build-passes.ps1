...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests must compile against the containment primitive and the partially-implemented runner.
