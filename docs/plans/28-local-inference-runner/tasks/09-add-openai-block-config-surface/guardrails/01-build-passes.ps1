...
#          guardrail on this task is meaningless over a tree that does not build, and for this task every later task in the plan compiles against these declarations - a broken surface here breaks all of them with an error none of them may fix.
