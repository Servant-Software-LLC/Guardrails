...
#          guardrail on this task is meaningless over a tree that does not build, and for this task a compile failure means the new verb was not wired into the command surface.
