...
#          guardrail on this task is meaningless over a tree that does not build, and for this task a compile failure means the two rerouted consumers no longer match the extractor's shape.
