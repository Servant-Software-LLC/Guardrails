...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the test drives the real ClaudePromptRunner and must compile against its current surface.
