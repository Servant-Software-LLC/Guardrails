...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests must compile against the task-09 stub - a non-compiling class silently removes task 11's whole gate.
