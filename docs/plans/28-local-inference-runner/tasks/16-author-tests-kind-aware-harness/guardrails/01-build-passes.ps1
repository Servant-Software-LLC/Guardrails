...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests drive the REAL GuardrailRunner and PromptComposer, so they must compile against their current signatures.
