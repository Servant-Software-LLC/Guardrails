...
#          guardrail on this task is meaningless over a tree that does not build, and for this task a compile failure means the composer's new capability parameter did not reach every call site.
