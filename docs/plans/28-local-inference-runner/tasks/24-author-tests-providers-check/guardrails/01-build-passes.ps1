...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests invoke the real CLI verb and must compile against its surface.
