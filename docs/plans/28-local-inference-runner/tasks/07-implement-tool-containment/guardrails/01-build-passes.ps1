...
#          guardrail on this task is meaningless over a tree that does not build, and for this task a compile failure means the primitive's signature drifted from what the tests and the runner expect.
