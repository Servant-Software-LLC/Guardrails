...
#          Verified discriminating: 'OpenAiCompatVerdictTests' is a substring of no other test class in this plan or in
#          the target project.
...
Write-Output "OpenAiCompatVerdictTests green: $executed executed, 0 failed."
exit 0
