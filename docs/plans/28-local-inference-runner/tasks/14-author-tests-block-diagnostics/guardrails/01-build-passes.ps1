...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests construct real plan fixtures and must compile against the current validator surface.
