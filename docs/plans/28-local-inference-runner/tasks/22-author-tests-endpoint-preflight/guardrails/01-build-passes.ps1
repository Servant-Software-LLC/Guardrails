...
#          guardrail on this task is meaningless over a tree that does not build, and for this task the tests drive the real preflight phase against a real loopback server and must compile against both.
