...
$filter = 'Category=RunEvents&FullyQualifiedName~TaskExecutorAttemptCompletionTests'   # SAME string as the pair's forward half
...
$manifest = [ordered]@{
    'a guardrail-failed attempt raises AttemptFinished with that outcome' = 'FailedAttempt_RaisesAttemptFinished_WithGuardrailFailedOutcome'
    'a max-turns attempt raises AttemptFinished with MaxTurns'            = 'MaxTurnsAttempt_RaisesAttemptFinished_WithMaxTurnsOutcome'
    'a succeeded attempt raises AttemptFinished with Succeeded'           = 'SucceededAttempt_RaisesAttemptFinished_WithSucceededOutcome'
    'a retried task raises it once per attempt, in order'                 = 'RetriedTask_RaisesAttemptFinished_OncePerAttempt'
}
