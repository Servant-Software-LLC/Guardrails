...
- [Guardrails/False-Green-First-Backlog](Guardrails/False-Green-First-Backlog/) — Working the "False Green First" Artifact backlog ranking (published 2026-09-06, https://claude.ai/artifact/KtrVo6xxrawL5JHXtZJ1T2) in priority order ahead of the Mac Studio Ultra (end of Oct 2026): #456 → #754 → #753 → #529 Case A → #382, plus closing/rescoping #478
...
- [Guardrails/Parallel-Agent-Comms](Guardrails/Parallel-Agent-Comms/) — Research into agent-to-agent communication between tasks running in parallel: the agentcomm evaluation vs. the missing-DAG-edge counter-hypothesis (issue #757)
...
- [Guardrails/System-One-Research](Guardrails/System-One-Research/) — Research into TypeSafe System One / Jev (calibrated typed-decision models) as a replacement for LLM judgment calls in the harness — issue #755
