...
public static class JournalJson
{
    ...
    public static string OutcomeToken(AttemptOutcome outcome) => outcome switch
    {
        ...
        AttemptOutcome.HarnessWriteRejected => "harness-write-rejected",
        AttemptOutcome.WriteScopeViolation => "write-scope-violation",
        AttemptOutcome.StagingFailed => "staging-failed",
    ...
    private sealed class AttemptOutcomeConverter : JsonConverter<AttemptOutcome>
    {
        public override AttemptOutcome Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return value switch
            {
                ...
                "harness-write-rejected" => AttemptOutcome.HarnessWriteRejected,
                "write-scope-violation" => AttemptOutcome.WriteScopeViolation,
                "staging-failed" => AttemptOutcome.StagingFailed,
